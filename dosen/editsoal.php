                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="ujian_id_221053"
                                        name="ujian_id_221053" value="<?= $data['judul_221053'] ?>" readonly>
                                </div>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="opsi_a_221053"
                                        name="opsi_a_221053" value="<?= $data['opsi_a_221053'] ?>" required>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="opsi_b_221053"
                                        name="opsi_b_221053" value="<?= $data['opsi_b_221053'] ?>" required>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="opsi_c_221053"
                                        name="opsi_c_221053" value="<?= $data['opsi_c_221053'] ?>" required>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="opsi_d_221053"
                                        name="opsi_d_221053" value="<?= $data['opsi_d_221053'] ?>" required>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <select class="form-control" id="jawaban_benar_221053"
                                        ...
                                        <option value="A"
                                            <?= $data['jawaban_benar_221053'] == 'A' ? 'selected' : '' ?>>A</option>
                                        <option value="B"
                                            <?= $data['jawaban_benar_221053'] == 'B' ? 'selected' : '' ?>>B</option>
                                        <option value="C"
                                            <?= $data['jawaban_benar_221053'] == 'C' ? 'selected' : '' ?>>C</option>
                                        <option value="D"
                                            <?= $data['jawaban_benar_221053'] == 'D' ? 'selected' : '' ?>>D</option>
                                    </select>
                                </div>

                                <button type="submit" id="submitButton" name="update"
