...
if(isset($_GET['generate_pdf'])) {
    ...
    while ($row = $result->fetch_assoc()) {
        $html .= '<tr>
                    <td>'.$no++.'</td>
                    <td>'.$row['nama_221053'].'</td>
                    <td>'.$row['judul_221053'].'</td>
                    <td>'.$row['nilai_221053'].'</td>
                    <td>'.$row['dikumpulkan_pada_221053'].'</td>
                  </tr>';
    }
    $html .= '</table>';
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form method="get" action="" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="text" name="mahasiswa" class="form-control" placeholder="Nama Mahasiswa" value="<?php echo htmlspecialchars($filter_mahasiswa); ?>">
                                </div>
                                <div class="col-md-3">
                                    <input type="text" name="ujian" class="form-control" placeholder="Judul Ujian" value="<?php echo htmlspecialchars($filter_ujian); ?>">
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <button type="submit" name="generate_pdf" target="_blank" value="1" class="btn btn-danger">Cetak PDF</button>
                                </div>
                            </div>
                        </form>
