...
if (isset($_POST['simpan'])) {
    ...
    $password = $_POST['password_221053'];
...
<body class="sb-nav-fixed">
                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="password" class="form-control" id="password_221053"
                                        name="password_221053" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const password = document.getElementById('password_221053');
